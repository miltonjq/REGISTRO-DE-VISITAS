            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        ...
                        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Registro visitas</span>
                        </a>
...
<p class="my-10 text-sm text-center text-gray-500">
    &copy; 2023-2023 <a href="https://flowbite.com/" class="hover:underline" target="_blank">Flowbite.com</a>. All rights reserved.
</p>

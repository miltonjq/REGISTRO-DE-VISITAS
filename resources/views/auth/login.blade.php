        ...
        <div class="flex flex-col gap-7 bg-white p-14 shadow-lg rounded-xl relative">
            ...
            <div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="relative">
                                <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-1 mr-0 mb-0 ml-2 font-medium text-gray-600
                                    absolute">Password</p>
                                <input placeholder="example@gmail.com" id="password"  type="password" name="password" required autocomplete="current-password" class="border placeholder-gray-400 focus:outline-none
                                    focus:border-black w-full pt-4 pr-4 pb-4 pl-4 mt-2 mr-0 mb-0 ml-0 text-base block bg-white
                                    border-gray-300 rounded-md"/>
                            </div>
                    ...
                    rounded-lg transition duration-200 hover:bg-indigo-600 ease">Ingresar</button>
